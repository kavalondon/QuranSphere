...
struct SalahStepsView: View {
    ...
    var body: some View {
        ZStack {
            ...
            // Zoomable Full-Screen Image Overlay
            if let imageName = expandedImage {
                ZoomableImageOverlay(imageName: imageName) {
    ...
    private var firstRakahSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(spacing: 16) {
                ExpandableStepCard(step: 1, title: "Takbeer", desc: "Raise both hands to your shoulders or ears, palms facing outward.", arabic: "اللهُ أَكْبَرُ", transliteration: "Allaahu Akbar", translation: "Allah is Greatest", imageName: "salah-step-02-takbeer", themeColor: sageGreen, expandedImage: $expandedImage)
                
                ExpandableStepCard(step: 2, title: "Seeking Refuge", desc: "Place your hands on your naval area, with the right hand over the left.", arabic: "أَعُوذُ بِاللَّهِ مِنَ الشَّيْطَانِ الرَّحِيمِ", transliteration: "A'oothu billaahi minash-shaytanir-rajeem", translation: "I seek refuge with Allah from Satan the accursed", imageName: "salah-step-03-qiyam", themeColor: accentGold, expandedImage: $expandedImage)
                
                ExpandableStepCard(step: 3, title: "Surah Al-Fatihah", desc: "Recite the opening chapter of the Qur'an.", arabic: "بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ\nالْحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ\nالرَّحْمَنِ الرَّحِيمِ\nمَالِكِ يَوْمِ الدِّينِ\nإِيَّاكَ نَعْبُدُ وَإِيَّاكَ نَسْتَعِينُ\nاهْدِنَا الصِّرَاطَ الْمُسْتَقِيمَ\nصِرَاطَ الَّذِينَ أَنْعَمْتَ عَلَيْهِمْ غَيْرِ الْمَغْضُوبِ عَلَيْهِمْ وَلَا الضَّالِّينَ\nآمين", transliteration: "Bismillaahir-rahmaanir-raheem\nAl-hamdu lillaahi rabbil 'aalameen\nAr-rahmaanir-raheem\nMaaliki yawmiddeen\nIyyaaka na'budu wa iyyaaka nasta'een\nIhdinas-siraatal mustaqeem\nSiratallatheena an'amta 'alayhim\nGhayril maghdoobi 'alayhim\nWaladdaalleen\nAameen", translation: "In the name of Allah, the Most Beneficent, the Most Merciful\nPraise be to Allah the Lord of the Worlds\nThe Most Beneficent, the Most Merciful\nMaster of the Day of Judgement\nYou alone we worship and in You alone we seek help\nGuide us to the straight path\nThe way of those whom You have favoured\nNot the way of those who have earned Your anger\nNor of those who have gone astray\nOh Allah answer our prayer!", imageName: "salah-step-03-qiyam", themeColor: sageGreen, expandedImage: $expandedImage)
                
                ExpandableStepCard(step: 4, title: "Another Surah", desc: "Recite another short chapter from the Qur'an.", arabic: nil, transliteration: nil, translation: nil, imageName: "salah-step-03-qiyam", themeColor: accentGold, expandedImage: $expandedImage)
                
                ExpandableStepCard(step: 5, title: "Ruku' (Bowing)", desc: "Say Allaahu Akbar, bow down, and praise Allah 3 times.", arabic: "سُبْحَانَ رَبِّيَ الْعَظِيمِ", transliteration: "Subhaana rabbiyal 'atheem", translation: "Glory be to my Lord the Supreme", imageName: "salah-step-04-ruku", themeColor: sageGreen, expandedImage: $expandedImage)
                
                ExpandableStepCard(step: 6, title: "Rising from Ruku'", desc: "Stand back up straight.", arabic: "سَمِعَ اللهُ لِمَنْ حَمِدَهُ\nرَبَّنَا وَ لَكَ الْحَمْد", transliteration: "Sami'-Allaahu liman hamidah\nRabbanaa wa lakal hamd", translation: "Allah listens to the one who praises him\nOur Lord, and to You belongs the praise", imageName: "salah-step-05-qawma", themeColor: accentGold, expandedImage: $expandedImage)
                
                ExpandableStepCard(step: 7, title: "First Sujood", desc: "Say Allaahu Akbar and prostrate on the ground. Praise Allah 3 times.", arabic: "سُبْحَانَ رَبِّي الأَعْلى", transliteration: "Subhaana rabbiyal 'alaa", translation: "Glory be to my Lord Most High", imageName: "salah-step-06-sujood", themeColor: sageGreen, expandedImage: $expandedImage)
                
                ExpandableStepCard(step: 8, title: "Sitting (Jalsa)", desc: "Sit up briefly on your left thigh and ask for forgiveness.", arabic: "رَبِّ اغْفِرْ لِي", transliteration: "Rabbighfirlee", translation: "Oh Allah, forgive me", imageName: "salah-step-07-jalsa", themeColor: accentGold, expandedImage: $expandedImage)
                
                ExpandableStepCard(step: 9, title: "Second Sujood", desc: "Prostrate a second time and praise Allah 3 times.", arabic: "سُبْحَانَ رَبِّي الأَعْلى", transliteration: "Subhaana rabbiyal 'alaa", translation: "Glory be to my Lord Most High", imageName: "salah-step-06-sujood", themeColor: sageGreen, expandedImage: $expandedImage)
            }
            .padding(.horizontal, 24)
        }
    }
    ...
    private var thirdAndFourthRakahSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(spacing: 16) {
                ExpandableStepCard(step: 12, title: "Stand Up Again", desc: "If praying Maghrib, Dhuhr, Asr, or Isha, stand up after the first Tashahhud.", arabic: nil, transliteration: nil, translation: nil, imageName: "salah-step-05-qawma", themeColor: accentGold, expandedImage: $expandedImage)
                
                ExpandableStepCard(step: 13, title: "Al-Fatihah Only", desc: "In the 3rd and 4th Rak'ahs, ONLY Surah Al-Fatihah is recited. Do not recite an additional Surah.", arabic: nil, transliteration: nil, translation: nil, imageName: "salah-step-03-qiyam", themeColor: sageGreen, expandedImage: $expandedImage)
                
                ExpandableStepCard(step: 14, title: "Repeat Movements", desc: "Perform Ruku' and Sujood just like the previous Rak'ahs.", arabic: nil, transliteration: nil, translation: nil, imageName: "salah-step-06-sujood", themeColor: accentGold, expandedImage: $expandedImage)
            }
            .padding(.horizontal, 24)
        }
    }
...
struct ZoomableImageOverlay: View {
    ...
    var body: some View {
        ZStack {
            // Dark Background (Tapping it dismisses the view)
